...
def main() -> None:
    ...
    extraction, extraction_usage = graph.extract_relations(contract_name, clauses)
    ...
    contract_id = args.contract_id if args.contract_id is not None else graph.next_contract_id()

    n_cross = graph.build_graph(
